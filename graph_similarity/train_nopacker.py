...
def main(DATASET_PATH, MODEL_PATH):
    ...
    # Build dataset
    dataset = build_datasets(config, DATASET_PATH, pairs_prop=PAIRS_PROP)
...
if __name__ == '__main__':
    ...
    DATASETS_PATH = "../paper_evaluation/graph_datasets/packware/integration/train"
    # iterate over all the directories in the datasets folder
    for dataset in os.listdir(DATASETS_PATH):
        DATASET_PATH = DATASETS_PATH + "/" + dataset + "/"
        MODEL_PATH = '../paper_evaluation/experiments/againstml/' + dataset + '/0/packware_' + dataset + '.pt'
