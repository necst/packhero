...
class TrainingPackedGraphSimilarityDataset(GraphSimilarityDataset):
    """Dataset for graph matching problems."""
    def __init__(self, dataset_path, validation_size = 0.1, permute=True, pairs_prop = 1):
      """Constructor.
      ...
      self._train_pairs = self.__gen_stratified_pairs__(self._train_files, pairs_prop=pairs_prop)
    ...
    def __gen_stratified_pairs__(self, files, neg_pos_prop = 1, pairs_prop = 1):
